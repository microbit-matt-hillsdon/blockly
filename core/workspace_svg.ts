  ...
  implements IContextMenu, IFocusableNode, IFocusableTree
{
  ...
  createDom(opt_backgroundClass?: string, injectionDiv?: HTMLElement): Element {
    ...
    if (injectionDiv) {
      ...
      // TODO: perhaps this one should be a listbox??
      ariaLabel = 'Flyout';
    ...
    aria.setRole(this.svgGroup_, aria.Role.APPLICATION);
    aria.setState(this.svgGroup_, aria.State.ROLEDESCRIPTION, ariaLabel);
